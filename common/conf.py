FB_FILE_NAME = "facebook_dataset.csv"
WEB_FILE_NAME = "website_dataset.csv"
GOOGLE_FILE_NAME = "google_dataset.csv"

FB_GOOGLE_WEB_FILE_NAME = "fb_google_web_dataset.csv"
